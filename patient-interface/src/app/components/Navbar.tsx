        ...
        <nav className="bg-white flex items-center justify-between p-4 min-w-full">  
              <div className="flex items-center transition ease-out duration-300 hover:w-[260px]">
                ...
                <ul className="flex items-center space-x-9 cursor-auto mr-5 font-bebas text-[2.9rem] text-text">
                    ...
                    <li className=" hover:text-primary"><Link href="https://http.dog/204.jpg">Book</Link></li>
                    <li className=" hover:text-primary"><Link href="https://http.dog/204.jpg">My pages</Link></li>
                </ul> 
            </nav>
    )
}
